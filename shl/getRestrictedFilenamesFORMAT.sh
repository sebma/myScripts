...
#			$debug
			...
			# printf "\x1b\x5b\x30\x6d\x1b\x5b\x30\x31\x3b\x33\x35\x6d\xf0\x9f\x9f\xa2 " | \hexdump -C
...
#			title=$(echo "$jsonHeaders" | $jq -n -r 'first(inputs | .title)' )
			...
			ytdlExtraOptions+=( --replace-in-metadata "video:title" " ?[\U00002B07-\U00002E7F]+" "" --replace-in-metadata "video:title" " ?[\U0000U+2FF0-\U0000U+2FFF]+" "" --replace-in-metadata "video:title" " ?[\U00002B00-\U0000DFFF]+" "" --replace-in-metadata "video:title" " ?[\U0000E000-\U0000F8FF]+" "" --replace-in-metadata "video:title" " ?[\U0000FE00-\U0000FE2F]+" "" --replace-in-metadata "video:title" " ?[\U0000FF00-\U0000FFFF]+" "" --replace-in-metadata "video:title" " ?[\U00010B40-\U0010ffff]+" "" ) # cf. https://github.com/yt-dlp/yt-dlp/issues/3047#issuecomment-2587024675
