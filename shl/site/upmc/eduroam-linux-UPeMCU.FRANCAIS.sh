...
function setup_environment {
  ...
  URL="votre page de support local eduroam"
  SUPPORT="reseau@upmc.fr"
if [ ! -z "$DISPLAY" ] ; then
...
if ! ask "Cet installateur ne fonctionnera correctement que si vous êtes membre de ${bf}Université Pierre et Marie Curie (UPMC).${n}" "Continuer" 1 ; then exit; fi
