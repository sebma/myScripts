		...
		then
			...
			case $distrib in
				Ubuntu)
					...
					echo
					consoleTools="fig2dev linux-image-generic lsof rename lsb-release bash-completion vim python-argcomplete htop command-not-found gpm conky-all dfc git smartmontools inxi aria2 gdebi-core speedtest-cli"
