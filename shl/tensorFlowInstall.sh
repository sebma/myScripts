		...
		then
			...
			case $distrib in
				Ubuntu)
					...
					echo
					consoleTools="transfig eog linux-image-generic texlive-xetex texlive-luatex texlive-extra-utils pdf2svg perl-doc lsof rename lsb-release bash-completion vim python-argcomplete htop command-not-found gpm conky-all dfc git smartmontools inxi aria2 gdebi-core speedtest-cli"
