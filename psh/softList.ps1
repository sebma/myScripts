...
#gp HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\* | ? Displayname -notMatch "update|microsoft" | Select Displayname , DisplayVersion , InstallDate | Sort -u Displayname | Format-Table
