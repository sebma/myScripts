...
function showRoutes {
#	Get-NetRoute -AddressFamily IPv4 @args | select DestinationPrefix,NextHop,InterfaceAlias,RouteMetric | findstr -v "224.0.0.0/4 /32"
	Get-NetRoute -AddressFamily IPv4 @args | select DestinationPrefix,NextHop,InterfaceAlias,RouteMetric | sls -NotMatch "224.0.0.0/4|/32"
}

function showRoutesV6 {
	Get-NetRoute -AddressFamily IPv6 @args | select DestinationPrefix,NextHop,InterfaceAlias,RouteMetric | findstr -v "fe80::/64 ff00::/8 /128"
}
