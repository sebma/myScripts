...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Université Pierre et Marie Curie (UPMC)"
Config.profilename = "eduroam"
Config.url = "your local eduroam® support page"
Config.email = "reseau@upmc.fr"
Config.title = "eduroam CAT"
Config.server_match = "radius.upmc.fr"
...
Config.user_realm = "upmc.fr"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.upmc.fr', 'DNS:radius.upmc.fr']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@upmc.fr"
Config.tou = ""
